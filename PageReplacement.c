...
// tanmay@tanmay-VirtualBox:~/os$ gcc testPR.c 
...
// Number of page faults using FCFS: 3
...
// Frames (Optimal): 12 X X 

// Frames (Optimal): 12 3 X 

// Frames (Optimal): 12 3 55 

// Frames (Optimal): 12 3 55 

// Frames (Optimal): 12 3 55 

// Number of page faults using Optimal: 3
